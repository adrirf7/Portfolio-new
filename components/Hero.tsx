...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="grid-bg min-h-screen pt-20 md:pt-36 pb-16 px-6 sm:px-10 md:px-16 lg:px-32 flex flex-col justify-center md:justify-start relative overflow-hidden transition-colors duration-300"
    >
